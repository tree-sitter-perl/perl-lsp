...
| `scaling-limits.md` §5 (`--heatmap` is a batch verb) | **Epic 8 Phase A LANDED** (2026-09-06: BMO 111 s → 8 s, byte-identical). The batch-verb framing stays honest; the measured residual (8-thread knee = allocation churn in the walk) and the deeper fan-in cost are Epic 15 Phase A |
