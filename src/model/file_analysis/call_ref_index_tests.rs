...
fn equal_span_first_write_wins() {
    ...
    let refs = vec![
        Ref {
            kind: RefKind::MethodCall {
                invocant: crate::model::conventions::Invocant::assume_canonical("$a"),
        ...
        Ref {
            kind: RefKind::MethodCall {
                invocant: crate::model::conventions::Invocant::assume_canonical("$b"),
                invocant_span: Some(Span {
                    start: Point::new(0, 0),
                    end: Point::new(0, 2),
                }),
    ...
    let fa = FileAnalysis::new(crate::model::file_analysis::FileAnalysisParts {
        scopes: vec![Scope {
            id: ScopeId(0),
            parent: None,
            kind: ScopeKind::File,
