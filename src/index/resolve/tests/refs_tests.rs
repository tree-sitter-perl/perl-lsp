//! refs_to / references_mask_for across workspace + cross-file scenarios.

use super::*;

pub(super) fn parse(source: &str) -> FileAnalysis {
...
"#;
    ...
    let f1_fa = crate::build::builder::build(&f1_tree, f1_src.as_bytes());
